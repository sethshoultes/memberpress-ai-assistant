 ...
 * Settings Page Class
 * 
 * Manages the plugin settings page using the Settings Registry
 *
...
/**
 * Class MPAI_Settings_Page
 */
class MPAI_Settings_Page {
    /**
     * Settings registry instance
     *
     * @var MPAI_Settings_Registry
     */
    private $registry;
    ...
    public function register_settings() {
        $this->registry = $this->register_default_settings($this->registry);
    }
    ...
    public function render_page() {
        ...
        // Render the settings page
        $this->registry->render_settings_page();
    }
     ...
     */
    private function register_default_settings($registry) {
        // General Tab
