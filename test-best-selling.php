...
<body>
    <div class="container">
        ...
        <div class="instructions">
            ...
            <p>The SQL query used counts completed transactions for each membership product and returns them in descending order of sales count.</p>
        </div>
...
$system_prompt .= "   - For best-selling memberships: {\"tool\": \"memberpress_info\", \"parameters\": {\"type\": \"best_selling\"}}\n";</div>
        ...
        <p>Once these changes are implemented, the AI assistant will be able to answer questions about the best-selling memberships using the MemberPress transaction data.</p>
